<template>
    <div class="about">
        ...
        <div class="haders">
            ...
            <span> <input type="text" class="input" placeholder="搜索头像"></span>
            <div class="down">
                <div class="dropdown">
        ...
        <div class="drop-down">
            <template>
                <el-tabs v-model="activeName" @tab-click="handleClick">
                    <el-tab-pane label="推荐" name="first1">
                        <div class="chat">
                            <div v-for="(item, index) in moblie" :key="index">
                                <router-link to="/det"><img :src=item.img></router-link>
                            </div>
                        </div>
                    </el-tab-pane>
                    <el-tab-pane label="女生头像" name="first2">
                        <div class="chat">
                            <div v-for="(item, index) in popular" :key="index"><img :src=item.image></div>
                        </div>
                    </el-tab-pane>
                    <el-tab-pane label="男生头像" name="first3">
                        <div class="chat">
                            <div v-for="(item, index) in moblie" :key="index"><img :src=item.img></div>
                        </div>
                    </el-tab-pane>
                    <el-tab-pane label="情侣头像" name="first4">
                        <div class="chat">
                            <div v-for="(item, index) in popular" :key="index"><img :src=item.image></div>
                        </div>
                    </el-tab-pane>
                    <el-tab-pane label="卡通头像" name="first5">
                        <div class="chat">
                            <div v-for="(item, index) in moblie" :key="index"><img :src=item.img></div>
                        </div>
                    </el-tab-pane>
                    <el-tab-pane label="非主流头像" name="first6">
                        <div class="chat">
                            <div v-for="(item, index) in popular" :key="index"><img :src=item.image></div>
                        </div>
                    </el-tab-pane>
                    <el-tab-pane label="闺蜜头像" name="first7">
                        <div class="chat">
                            <div v-for="(item, index) in moblie" :key="index"><img :src=item.img></div>
                        </div>
                    </el-tab-pane>
                    <el-tab-pane label="欧美头像" name="first8">
                        <div class="chat">
                            <div v-for="(item, index) in popular" :key="index"><img :src=item.image></div>
                        </div>
                    </el-tab-pane>
                    <el-tab-pane label="唯美头像" name="first9">
                        <div class="chat">
                            <div v-for="(item, index) in moblie" :key="index"><img :src=item.img></div>
                        </div>
                    </el-tab-pane>
                    <el-tab-pane label="带字头像" name="first10">
                        <div class="chat">
                            <div v-for="(item, index) in popular" :key="index"><img :src=item.image></div>
                        </div>
                    </el-tab-pane>
                    <el-tab-pane label="动物头像" name="first11">
                        <div class="chat">
                            <div v-for="(item, index) in moblie" :key="index"><img :src=item.img></div>
                        </div>
                    </el-tab-pane>
                    <el-tab-pane label="搞怪头像" name="first12">
                        <div class="chat">
                            <div v-for="(item, index) in popular" :key="index"><img :src=item.image></div>
                        </div>
                    </el-tab-pane>
                    <el-tab-pane label="明星头像" name="first13">
                        <div class="chat">
                            <div v-for="(item, index) in moblie" :key="index"><img :src=item.img></div>
                        </div>
                    </el-tab-pane>
                    <el-tab-pane label="抖音头像" name="first14">
                        <div class="chat">
                            <div v-for="(item, index) in popular" :key="index"><img :src=item.image></div>
                        </div>
                    </el-tab-pane>
                    <el-tab-pane label="节日头像" name="first15">
                        <div class="chat">
                            <div v-for="(item, index) in moblie" :key="index"><img :src=item.img></div>
                        </div>
                    </el-tab-pane>
        ...
        <div class="footert">
            ...
            <!-- 分享 -->
            <div>
                <svg @click="shares" t="1704423087961" class="icon" viewBox="0 0 1024 1024" version="1.1"
                    xmlns="http://www.w3.org/2000/svg" p-id="3012" width="25" height="25">
                    <path
...
export default {
    ...
    mounted() {
        axios.get('http://127.0.0.1:3000/wall/hade')
            .then((response) => {
        ...
        axios.get('http://127.0.0.1:3000/wall/avatarlist')
            .then((response) => {
